...
import com.study.inf.InfApplication;
...
@AnalyzeClasses(packagesOf = InfApplication.class)
public class PackageDependencyTests {
    ...
    // @ArchTest
    // ArchRule modulesPackageRule =
    // classes().that().resideInAPackage("com.study.inf.modules..")
    // .should().onlyBeAccessed().byClassesThat().resideInAnyPackage("com.study.inf.modules..");
